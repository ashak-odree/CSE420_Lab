...
%token IF ELSE FOR ID LPAREN RPAREN LCURL RCURL ADDOP ASSIGNOP DECOP INCOP LOGICOP MULOP RELOP DOUBLE COMMA CONST_FLOAT CONST_INT SEMICOLON LTHIRD RTHIRD RANGE NOT CATCH WHILE DO BREAK TRY EXCEPT TRUE FALSE DEF FINALLY AND OR PRINT IN PASS NONE CONTINUE RETURN INT FLOAT CHAR VOID SWITCH CASE DEFAULT PRINTLN
